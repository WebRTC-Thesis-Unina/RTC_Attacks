...
- <b>node</b>: container che gestisce il backend della web application, vulnerabile all'attacco.
...
- <b>VDO.Ninja</b>: container che simula la piattaforma VDO.Ninja, per gestire comunicazioni audio video. E' vulnerabile a XSS.
